...
function addProcessArgs(settings, args) {
    ...
    settings.s = args.s || args.secret || settings.secret;
...
program
    ...
    .option('-s, --secret <secret>', 'secret key string for the post request, will generate one to stdout if it is not provided')
...
program
    ...
    .action(function() {
        ...
        new Restaurant(previousSettings, function () {
